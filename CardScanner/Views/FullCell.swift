...
//  CardScanner
//
//  Created by Filip Zeman on 14.01.2022.
//

import UIKit

class FullCell: UIView, UITextFieldDelegate, UITextViewDelegate {
    ...
    private func prepareHeaderTextField() {
        ...
        headerTextField.font = .boldSystemFont(ofSize: 20)
    ...
    private func prepareDetailTextField() {
        ...
        detailTextField.font = .systemFont(ofSize: 17)
        detailTextField.textAlignment = .center

        detailTextField.snp.makeConstraints { make in
            make.top.equalTo(headerTextField.snp.bottom).offset(5)
            make.leading.equalToSuperview().offset(10)
            make.trailing.equalToSuperview().offset(-10)
